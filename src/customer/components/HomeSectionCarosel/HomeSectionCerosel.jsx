...
const HomeSectionCerosel = ({data,sectionName}) => {
  ...
  return (
    <div className=' border'>
      <h2 className='text-2xl font-extrabold text-grat-800 py-5'>{sectionName}</h2>
      <div className='relative p-5'>
        ...
        <Button onClick={slideNext} variant='contained' className='z-50' sx={{
...
export default HomeSectionCerosel